...
export default function Home(){
    ...
    return (
        ...
        <footer className={styles.footer}>
            Check out the <a href="https://github.com/Idot07/password-game" target="_blank">GitHub</a> for this project. <br/>
            This site is heavily inspired by&nbsp;
            <a href="https://yourmom.com/" target="_blank">The Password Game</a> by&nbsp;
            <a href="https://discord.com/users/715859962315669556" target="_blank">Idot</a>
        </footer>
        </>
      )
}